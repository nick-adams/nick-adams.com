...
<div class="grid--maxwidth grid--outsidegutters">
    ...
    <header class="project-cover">
      <div class="project-feature" style="background-image: url(../../assets/img/case-studies/hudl-ios/bg-project-hudl-ios-feature.png)"></div>
...
Despite all of the struggles outlined above being the prevailing feelings within the company, it was still important to bring a critical perspective to validate them. To ask “Why?”,  “Is there a deeper problem here?”, and most importantly “What are our _customers_ feeling?”. It was my job to ask these questions, and diving into last question in particular is where we always spent a majority of our time.
...
-   **The app was fragmented and lacked cohesion.** Users were confused with no clear entry point into the app or ways to get around (which increased the perception of a lack of parity because users couldn’t find features even if they _were_ there).
